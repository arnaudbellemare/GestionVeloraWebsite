...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    fr: {
      category: "Réglementation",
      date: "Août 2026",
      title: "Augmentation de loyer 2026 au Québec : calcul TAL, avis et délais",
      metaTitle: "Augmentation de loyer 2026 : calcul TAL et formulaire",
      excerpt: "Augmentation de loyer 2026 au Québec : base TAL de 3,1 %, calcul réel, formulaire d'avis, délais de réponse et procédure après un refus.",
      brief: "Pour un avis transmis à compter du 1er janvier 2026, le TAL publie une composante de base de 3,1 %, et non un plafond automatique. Le résultat dépend ensuite de l'immeuble. L'avis suit des délais précis; le locataire a un mois pour refuser et le propriétaire un mois après le refus pour saisir le TAL.",
      sections: [
        {
          heading: "Quel est le pourcentage d'augmentation de loyer du TAL en 2026 ?",
          paragraphs: [
            [
              "Pour les avis de modification transmis à compter du 1er janvier 2026, le ",
              { text: "tableau officiel du TAL", to: "https://www.tal.gouv.qc.ca/fr/reconduction-du-bail-et-fixation-de-loyer/pourcentages-applicables-aux-criteres-de-fixation-de-loyer" },
              " indique une composante de base de 3,1 %. Cette nouvelle composante remplace les raccourcis par type de chauffage : il n'existe pas un taux universel distinct pour logement chauffé et non chauffé applicable à tous les dossiers 2026.",
            ],
            ...
            [
              "Le propriétaire peut utiliser l'",
              { text: "outil de calcul 2026 du TAL", to: "https://www.tal.gouv.qc.ca/fr/calcul-pour-l-augmentation-de-loyer" },
              " pour préparer une proposition documentée. Les avis transmis avant le 1er janvier 2026 demeurent assujettis à l'ancienne méthode par composantes; la date de l'avis détermine donc le régime applicable.",
            ],
          ],
        },
        {
          heading: "Avis d'augmentation de loyer 2026 : formulaire et délais",
          paragraphs: [
            ...
            [
              "L'",
              { text: "avis officiel d'augmentation du TAL", to: "https://www.tal.gouv.qc.ca/sites/default/files/notices/TAL_806_E.pdf" },
              " prévoit les mentions essentielles : modification proposée, nouveau loyer ou hausse en dollars ou en pourcentage, date d'entrée en vigueur, délai d'un mois pour refuser, texte réglementaire obligatoire, date et signature. Utiliser ce modèle réduit le risque d'omettre une mention requise.",
            ],
            [
              "Conservez une preuve de réception valide, par exemple un envoi recommandé ou une remise en mains propres avec accusé. Un ",
              { text: "gestionnaire immobilier professionnel", to: "/services/gestion-locative" },
              " peut centraliser les dates de renouvellement, les calculs, les avis et les preuves de réception pour chaque logement, particulièrement lorsqu'un immeuble comporte plusieurs échéances de bail.",
            ],
          ],
        },
        {
          heading: "Que se passe-t-il après un refus d'augmentation de loyer ?",
          paragraphs: [
    ...
    en: {
      category: "Regulation",
      date: "August 2026",
      title: "Quebec rent increase 2026: TAL calculation, notice and deadlines",
      metaTitle: "Quebec Rent Increase 2026: TAL Rate and Notice",
      excerpt: "Quebec rent increase 2026: TAL's 3.1% base component, property-specific calculation, notice deadlines, tenant response and refusal procedure.",
      brief: "For notices served on or after January 1, 2026, the TAL publishes a 3.1% base component—not an automatic ceiling. The building's figures still affect the result. Tenants have one month to refuse, and landlords have one month after receiving a refusal to apply to the TAL.",
      sections: [
        {
          heading: "What is the TAL rent increase percentage for 2026?",
          paragraphs: [
            [
              "For modification notices served on or after January 1, 2026, the ",
              { text: "TAL's official percentage table", to: "https://www.tal.gouv.qc.ca/en/renewal-of-the-lease-and-fixing-of-rent/applicable-percentages-to-the-criteria-for-the-fixing-of-rent" },
              " lists a 3.1% base component. This replaces shortcuts based solely on heating type: there is no separate universal heated-versus-unheated rate for every 2026 file.",
            ],
        ...
        {
          heading: "Quebec rent increase notice: form and deadlines",
          paragraphs: [
            ...
            [
              "A professional ",
              { text: "property manager", to: "/services/gestion-locative" },
              " can centralize renewal dates, calculations, notices and proof of receipt for every unit, particularly when a building has several lease-expiry dates.",
            ],
          ],
        },
        {
          heading: "What happens after a tenant refuses the rent increase?",
          paragraphs: [
            ...
            [
              "After receiving a refusal, the landlord has one month to apply to the TAL for rent fixing or another lease modification. Missing that deadline renews the lease at the existing rent and conditions. The deadline runs from receipt of the refusal—not from lease end. The ",
              { text: "TAL's rent-increase guidance", to: "https://www.tal.gouv.qc.ca/en/renewal-of-the-lease-and-fixing-of-rent/rent-increase" },
        ...
        },
        {
          ...
          paragraphs: [
            ...
            [
              "Pour nos ",
              { text: "syndicats de copropriété", to: "/services/syndicat-copropriete" },
              " et nos propriétaires, la propreté des parties communes est une composante directe de la valeur perçue et de la satisfaction des résidents. Un immeuble bien entretenu, aux espaces communs impeccables, fidélise les locataires et protège la valeur du bâtiment à long terme.",
            ],
            "Nickel & Krome intervient ponctuellement ou de façon récurrente selon les besoins de chaque immeuble. Leur flexibilité et leur réactivité s'intègrent naturellement à notre modèle de gestion proactive, où chaque intervention est planifiée, documentée et suivie dans notre tableau de bord.",
          ],
        },
        {
          heading: "Nettoyage post-construction : un service essentiel pour les copropriétés",
          paragraphs: [
            "Le nettoyage post-construction est souvent sous-estimé dans le calendrier d'un projet immobilier. Pourtant, la qualité de cette étape conditionne la première impression des résidents et la conformité aux standards d'un syndicat bien géré. Nickel & Krome maîtrise ce segment avec une précision qui évite les allers-retours coûteux et les corrections de dernière minute.",
            [
              "Pour les promoteurs et gestionnaires qui cherchent une compagnie de nettoyage fiable à Montréal, Nickel & Krome représente un choix solide. N'hésitez pas à les contacter directement via leur site ",
              { text: "nickelandkrome.ca", to: "https://nickelandkrome.ca" },
              " ou par téléphone au +1-514-699-3317.",
            ],
            [
              "Gestion Velora recommande Nickel & Krome à nos clients qui en font la demande. Si vous gérez un immeuble à Montréal ou Laval et souhaitez en savoir plus sur notre réseau de partenaires de confiance, ",
              { text: "contactez-nous", to: "/#contact" },
              ".",
            ],
          ],
        },
        ...
        },
        {
          ...
          paragraphs: [
            ...
            [
              "For our ",
              { text: "condo boards", to: "/services/syndicat-copropriete" },
              " and property owners, clean common areas are a direct component of perceived value and resident satisfaction. A well-maintained building with impeccable shared spaces retains tenants and protects long-term asset value.",
            ],
            "Nickel & Krome intervenes on a one-time or recurring basis depending on each building's needs. Their flexibility and responsiveness integrate naturally into our proactive management model, where every intervention is planned, documented, and tracked in our dashboard.",
          ],
        },
        {
          heading: "Post-construction cleaning: an essential service for condominiums",
          paragraphs: [
            "Post-construction cleaning is often underestimated in a real estate project timeline. Yet the quality of this step sets the first impression for residents and ensures compliance with the standards expected by a well-run condo board. Nickel & Krome handles this segment with a precision that avoids costly back-and-forth and last-minute corrections.",
            [
              "For developers and managers looking for a reliable cleaning company in Montreal, Nickel & Krome is a solid choice. Contact them directly through their website ",
              { text: "nickelandkrome.ca", to: "https://nickelandkrome.ca" },
              " or by phone at +1-514-699-3317.",
            ],
            [
              "Gestion Velora recommends Nickel & Krome to clients who request it. If you manage a building in Montreal or Laval and want to learn more about our trusted partner network, ",
