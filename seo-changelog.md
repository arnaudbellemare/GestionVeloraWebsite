...
| 2026-09-14 | _pending_ | Added six bilingual, answer-first landlord risk guides: TAL evidence preparation; unpaid rent and conditional second proceedings; locating a departed tenant through a licensed civil investigator; evaluating the sale of an unpaid-rent claim to GJQ; no-notice departures and damage evidence; and privacy-conscious tenant screening with SOQUIJ, credit consent, and verified landlord references. Primary sources include TAL, the Civil Code of Québec, CAI, SOQUIJ, and BSP; third-party services are identified without endorsement or outcome guarantees. Updated `llms.txt`, `llms-full.md`, and the crawler-facing Markdown blog index. Prerender and AMP output regenerated; sitemap now contains 406 URLs and derives blog `lastmod` from each article's `dateModified`; RSS now regenerates from `blogPosts` instead of remaining a stale hand-maintained feed. |
| 2026-09-14 | _pending_ | Added four bilingual condo-governance guides covering the Loi 16 transition and 2028 deadline, presenting a reserve study at the owners' meeting, building condo fees from operating/reserve/self-insurance requirements, and the regulated self-insurance deductible formula. Corrected the existing Loi 141 article to distinguish insurance duties from Loi 16 planning duties and corrected reconstruction valuation from three years to at least five years. Refreshed the existing reserve-fund guide, AI indexes, Markdown index, sitemap, AMP, and RSS. Primary sources: Québec.ca, the Civil Code of Québec, and `CCQ, r. 4.1`. |
