...
var l = o((e => {
    ...
    function O(e, r, i, a, o) {
        ...
        if (c)
            ...
            O(o, r, i, ``, function(e) {
                return e
            })) : o != null && (E(o) && (o = te(o, i + (o.key == null || e && e.key === o.key ? `` : (`` + o.key).replace(ne, `$&/`) + `/`) + c)),
            r.push(o)),
            1;
        c = 0;
        var l = a === `` ? `.` : a + `:`;
            ...
            try {
                a: {
                    ...
                    try {
                        b: {
                            for (b(t),
                            d = n(c); d !== null && !(d.expirationTime > t && T()); ) {
                                var o = d.callback;
...
` + e.stack
    ...
    function Qe(e, t, n) {
        ...
        return s === 0 ? (s = r & ~a,
        s === 0 ? o === 0 ? n || (n = r & ~e,
        n !== 0 && (i = Ze(n))) : i = Ze(o) : i = Ze(s)) : (r = s & ~a,
        r === 0 ? (o &= s,
        o === 0 ? n || (n = s & ~e,
        n !== 0 && (i = Ze(n))) : i = Ze(o)) : i = Ze(r)),
    ...
    var wn = {
        ...
        movementX: function(e) {
            return `movementX`in e ? e.movementX : (e !== An && (An && e.type === `mousemove` ? (On = e.screenX - An.screenX,
            kn = e.screenY - An.screenY) : kn = On = 0,
            An = e),
            On)
        },
    ...
    var Un = Cn(h({}, En, {
        key: function(e) {
            ...
            e === 13 ? `Enter` : String.fromCharCode(e)) : e.type === `keydown` || e.type === `keyup` ? zn[e.keyCode] || `Unidentified` : ``
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
    ...
    function or(e, t) {
        if (ir)
            return e === `compositionend` || !Xn && nr(e, t) ? (e = yn(),
            vn = _n = gn = null,
            ir = !1,
            e) : null;
        switch (e) {
    ...
    function lr(e, t, n, r) {
        ...
        t = Ed(t, `onChange`),
        0 < t.length && (n = new Tn(`onChange`,`change`,null,n,r),
        e.push({
            event: n,
            listeners: t
        }))
    ...
    function yr() {
        ur && (ur.detachEvent(`onpropertychange`, br),
        dr = ur = null)
    }
    function br(e) {
    ...
    function xr(e, t, n) {
        ...
        ur = t,
        dr = n,
        ur.attachEvent(`onpropertychange`, br)) : e === `focusout` && yr()
    }
    function Sr(e) {
    ...
    function Rr(e, t, n) {
        ...
        Lr || Pr == null || Pr !== Bt(r) || (r = Pr,
        `selectionStart`in r && Mr(r) ? r = {
        ...
        Ir && Dr(Ir, r) || (Ir = r,
        r = Ed(Fr, `onSelect`),
        0 < r.length && (t = new Tn(`onSelect`,`select`,null,t,n),
        e.push({
            event: t,
            listeners: r
        }),
    ...
    var Br = {
      ...
      , Vr = {}
      , Hr = {};
    pn && (Hr = document.createElement(`div`).style,
    ...
    var Li = null
      ...
      , Bi = Error(i(519));
    function Vi(e) {
        throw qi(Si(Error(i(418, 1 < arguments.length && arguments[1] !== void 0 && arguments[1] ? `text` : `HTML`, ``)), e)),
        Bi
    }
    function Hi(e) {
        var t = e.stateNode
    ...
    function Wi(e) {
        ...
        t === 13) {
            ...
            Zd(e.type) ? (e = lf,
            lf = null,
            F = e) : F = t) : F = Li ? cf(e.stateNode.nextSibling) : null;
        return !0
    }
    function Gi() {
        F = Li = null,
    ...
    var Ji = ue(null)
      ...
      , Xi = null;
    function Zi(e, t, n) {
        j(Ji, t._currentValue),
        t._currentValue = n
    }
    function Qi(e) {
        e._currentValue = Ji.current,
        de(Ji)
    }
    function $i(e, t, n) {
        for (; e !== null; ) {
    ...
    function Ba(e) {
        ...
        function l(e, t, n, r) {
            var i = n.type;
            return i === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === E && ja(i) === t.type) ? (t = a(t, n.props),
            Ra(t, n),
            t.return = e,
    ...
    function No(e) {
        ...
        k.H = t === null || t.memoizedState === null ? Bs : Vs),
        e
    }
    function Po(e) {
        if (typeof e == `object` && e) {
    ...
    function Ss(e, t, n, r) {
        return Er(n, t) ? n : to.current === null ? !(ho & 42) || ho & 1073741824 && !(J & 261930) ? (ic = !0,
    ...
    function Cs(e, t, n, r, i) {
        ...
        try {
            var c = i()
              , l = k.S;
            l !== null && l(s, c),
            typeof c == `object` && c && typeof c.then == `function` ? Ps(e, t, ya(c, r), pu(e)) : Ps(e, t, r, pu(e))
        } catch (n) {
            Ps(e, t, {
                then: function() {},
                status: `rejected`,
    ...
    function Gs(e, t, n, r, i, a, o) {
        ...
        typeof e.shouldComponentUpdate == `function` ? e.shouldComponentUpdate(r, a, o) : t.prototype && t.prototype.isPureReactComponent ? !Dr(n, r) || !Dr(i, a) : !0
    }
    function Ks(e, t, n, r) {
        e = t.state,
    ...
    function nc(e, t, n, r, a) {
        ...
        typeof r == `object` && r && typeof r.then == `function`) {
            ...
            n !== null) {
                ...
                case 31:
                case 13:
                    return so === null ? Du() : n.alternate === null && X === 0 && (X = 3),
                    n.flags &= -257,
                    n.flags |= 65536,
                    n.lanes = a,
                    r === Oa ? n.flags |= 16384 : (t = n.updateQueue,
    ...
    function lc(e, t, n, r) {
        ...
        r.mode === `hidden`) {
            ...
            a === null ? (e !== null && Ca(t, null),
            io(),
            fo(t)) : (Ca(t, a.cachePool),
            ro(t, a),
            fo(t),
            t.memoizedState = null);
        return ac(e, t, i, n),
    ...
    function vc(e, t, n, r, i) {
        ...
        t.stateNode === null) {
            ...
            o !== d || f !== p || Ua || e !== null && e.dependencies !== null && na(e.dependencies) ? (typeof s == `function` && (Us(t, n, s, r),
            p = t.memoizedState),
            (u = Ua || Gs(t, n, u, r, f, p, c) || e !== null && e.dependencies !== null && na(e.dependencies)) ? (l || typeof a.UNSAFE_componentWillUpdate != `function` && typeof a.componentWillUpdate != `function` || (typeof a.componentWillUpdate == `function` && a.componentWillUpdate(r, p, c),
    ...
    function Cc(e, t, n) {
        ...
        a === null ? a = wa() : (l = ua._currentValue,
        a = a.parent === l ? a : {
            parent: l,
            pool: l
        }),
    ...
    function Nc(e, t, n) {
        if (e !== null)
            ...
            ic = !1,
            I && t.flags & 1048576 && Ni(t, Ei, t.index);
        switch (t.lanes = 0,
        t.tag) {
        case 16:
            a: {
        ...
        case 26:
            return hc(e, t),
            e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : I || (n = t.type,
            e = t.pendingProps,
        ...
        case 27:
            return ve(t),
            e === null && I && (r = t.stateNode = ff(t.type, t.pendingProps, me.current),
            Li = t,
            zi = !0,
            a = F,
            Zd(t.type) ? (lf = a,
            F = cf(r.firstChild)) : F = a),
            ac(e, t, t.pendingProps.children, n),
            hc(e, t),
            e === null && (t.flags |= 4194304),
            t.child;
        case 5:
            return e === null && I && ((a = r = F) && (r = tf(r, t.type, t.pendingProps, zi),
            ...
            t.child;
        case 6:
            return e === null && I && ((e = n = F) && (n = nf(n, t.pendingProps, zi),
    ...
    function Lc(e, t) {
        t !== null && (e.flags |= 4),
        e.flags & 16384 && (t = e.tag === 22 ? 536870912 : et(),
        e.lanes |= t,
        Yl |= t)
    }
    function Rc(e, t) {
    ...
    function zc(e, t, n) {
        ...
        case 3:
            ...
            (e === null || e.child === null) && (Wi(t) ? Pc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024,
            Ki())),
            U(t),
            null;
        case 26:
            ...
            o === null)
                        ...
                        for (e = t.child; e !== null; ) {
                            ...
                            o !== null) {
                                ...
                                n = t.child; n !== null; )
                                    hi(n, e),
                                    n = n.sibling;
                                return j(L, L.current & 1 | 2),
                                I && Mi(t, r.treeForkCount),
                                t.child
                            }
                            e = e.sibling
                        }
                    r.tail !== null && Me() > tu && (t.flags |= 128,
                    a = !0,
                    Rc(r, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!a)
                    ...
                    e !== null) {
                        ...
                        Lc(t, e),
                        Rc(r, !0),
                        r.tail === null && r.tailMode === `hidden` && !o.alternate && !I)
                            return U(t),
                            null
                    } else
                        2 * Me() - r.renderingStartTime > tu && n !== 536870912 && (t.flags |= 128,
                        a = !0,
                        Rc(r, !1),
                        t.lanes = 4194304);
    ...
    function vl(e, t) {
                        ...
                        if (e.stateNode === null) {
                            a: {
                                ...
                                case `title`:
                                    ...
                                    (!o || o[_t] || o[P] || o.namespaceURI === `http://www.w3.org/2000/svg` || o.hasAttribute(`itemprop`)) && (o = a.createElement(r),
        ...
        case 13:
            gl(t, e),
            yl(e),
            e.child.flags & 8192 && e.memoizedState !== null != (n !== null && n.memoizedState !== null) && ($l = Me()),
            r & 4 && (r = e.updateQueue,
            r !== null && (e.updateQueue = null,
            hl(e, r)));
            break;
    ...
    function Pu(e, t, n, r) {
        ...
        t.flags & 32768 ? (I || r === 1 ? e = !0 : Hl || J & 536870912 ? e = !1 : (Vl = e = !0,
    ...
    function Ku(e, t, n) {
        ...
        e.warmLanes &= ~n,
        K === e && (J & n) === n && (X === 4 || X === 3 && (J & 62914560) === J && 300 > Me() - $l ? !(G & 2) && Su(e, 0) : ql |= n,
        Yl === J && (Yl = 0)),
        rd(e)
    }
    function qu(e, t) {
    ...
    function cd(e, t) {
        ...
        if (Hu() && e.callbackNode !== n)
            return null;
        var r = J;
        return r = Qe(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1),
        r === 0 ? null : (gu(e, r, t),
        sd(e, Me()),
            ...
            if (!(t & 7)) {
                a: {
                    ...
                    l !== u)) {
                        ...
                        p = `onMouseEnter`,
                        m = `mouse`,
                        (e === `pointerout` || e === `pointerover`) && (d = Wn,
                        g = `onPointerLeave`,
                        p = `onPointerEnter`,
                        m = `pointer`),
                        f = l == null ? c : xt(l),
                ...
                a: {
                    ...
                    l === `select` || l === `input` && c.type === `file`)
                        ...
                        l = c.nodeName,
                        !l || l.toLowerCase() !== `input` || c.type !== `checkbox` && c.type !== `radio` ? r && $t(r.elementType) && (v = mr) : v = Cr;
                    if (v &&= v(e, r)) {
                        lr(s, v, n, i);
                        break a
                    }
                ...
                e) {
                case `focusin`:
                    (cr(y) || y.contentEditable === `true`) && (Pr = y,
                    Fr = r,
                    Ir = null);
                    break;
                case `focusout`:
                ...
                if (Xn)
                    ...
                    ir ? nr(e, n) && (x = `onCompositionEnd`) : e === `keydown` && n.keyCode === 229 && (x = `onCompositionStart`);
                x && ($n && n.locale !== `ko` && (ir || x !== `onCompositionStart` ? x === `onCompositionEnd` && ir && (b = yn()) : (gn = i,
                _n = `value`in gn ? gn.value : gn.textContent,
                ir = !0)),
                y = Ed(r, x),
                0 < y.length && (x = new Ln(x,e,null,n,i),
                s.push({
                    event: x,
                    listeners: y
                }),
                b ? x.data = b : (b = rr(n),
                b !== null && (x.data = b)))),
                (b = Qn ? ar(e, n) : or(e, n)) && (x = Ed(r, `onBeforeInput`),
                0 < x.length && (y = new Ln(`onBeforeInput`,`beforeinput`,null,n,i),
                s.push({
                    event: y,
                    listeners: x
                }),
...
`).replace(Ad, ``)
  ...
  , oe = 5e4;
function k(e) {
    return `vec3f(${e.r.toFixed(6)}, ${e.g.toFixed(6)}, ${e.b.toFixed(6)})`
}
var A = `
struct Uniforms {
  aspectRatio: f32,
...
`
  ...
  , Te = o((e => {
    ...
    e.getPositions = function(t) {
        ...
        for (let e = 0; e < i; e++)
            for (let t = 0; t < i; t++)
                e === 0 && t === 0 || e === 0 && t === i - 1 || e === i - 1 && t === 0 || n.push([r[e], r[t]]);
        return n
    }
}
))
  ...
  , De = o((e => {
    ...
    e.getPenaltyN1 = function(e) {
        ...
        for (let c = 0; c < n; c++) {
            ...
            for (let l = 0; l < n; l++) {
                let n = e.get(c, l);
                n === o ? i++ : (i >= 5 && (r += t.N1 + (i - 5)),
                o = n,
                i = 1),
                n = e.get(l, c),
                n === s ? a++ : (a >= 5 && (r += t.N1 + (a - 5)),
                s = n,
                a = 1)
            }
            i >= 5 && (r += t.N1 + (i - 5)),
  ...
  , Fe = o((e => {
    ...
    function d(t, n) {
        for (let r = 1; r <= 40; r++)
            if (u(t, r) <= e.getCapacity(r, n, i.MIXED))
                return r
    }
    e.from = function(e, t) {
  ...
  , Ie = o((e => {
    ...
    e.getEncodedBits = function(e, a) {
        let o = e.bit << 3 | a
          , s = o << 10;
        for (; t.getBCHDigit(s) - i >= 0; )
            s ^= n << t.getBCHDigit(s) - i;
        return (o << 10 | s) ^ r
    }
}
))
...
Make sure your charset is UTF-8`);
    ...
    var n = {
        ...
        PriorityQueue: {
            make: function(e) {
                ...
                return r.queue = [],
                r.sorter = e.sorter || t.default_sorter,
                r
            },
  ...
  , He = o((e => {
    ...
    function d(e) {
        ...
        return s.isKanjiModeEnabled() ? (i = u(o.BYTE, t.BYTE, e),
        a = u(o.KANJI, t.KANJI, e)) : (i = u(o.BYTE_KANJI, t.BYTE, e),
        a = []),
        n.concat(r, i, a).sort(function(e, t) {
        ...
        for (let o = 0; o < e.length; o++) {
            ...
            for (let e = 0; e < s.length; e++) {
                ...
                for (let e = 0; e < a.length; e++) {
                    let o = a[e];
                    r[o] && r[o].node.mode === l.mode ? (i[o][u] = f(r[o].lastCount + l.length, l.mode) - f(r[o].lastCount, l.mode),
                    r[o].lastCount += l.length) : (r[o] && (r[o].lastCount = l.length),
    ...
    function g(e, o) {
        ...
        if (c = t.from(o, l),
        c !== t.BYTE && c.bit < l.bit)
            throw Error(`"` + e + `" cannot be encoded with mode ` + t.toString(c) + `.
 Suggested mode is: ` + t.toString(l));
        switch (c === t.KANJI && !s.isKanjiModeEnabled() && (c = t.BYTE),
        c) {
        case t.NUMERIC:
            return new n(e);
        case t.ALPHANUMERIC:
    ...
    e.fromArray = function(e) {
        return e.reduce(function(e, t) {
            return typeof t == `string` ? e.push(g(t, null)) : t.data && e.push(g(t.data, t.mode)),
            e
        }, [])
    }
    ,
  ...
  , Ue = o((e => {
    ...
    function m(e, t) {
        ...
        for (let t = 0; t < r.length; t++) {
            ...
            for (let t = -1; t <= 7; t++)
                if (!(i + t <= -1 || n <= i + t))
                    for (let r = -1; r <= 7; r++)
                        a + r <= -1 || n <= a + r || (t >= 0 && t <= 6 && (r === 0 || r === 6) || r >= 0 && r <= 6 && (t === 0 || t === 6) || t >= 2 && t <= 4 && r >= 2 && r <= 4 ? e.set(i + t, a + r, !0, !0) : e.set(i + t, a + r, !1, !0))
        }
    }
    function h(e) {
        let t = e.size;
    ...
    function g(e, t) {
        ...
        for (let t = 0; t < n.length; t++) {
            ...
            for (let t = -2; t <= 2; t++)
                for (let n = -2; n <= 2; n++)
                    t === -2 || t === 2 || n === -2 || n === 2 || t === 0 && n === 0 ? e.set(r + t, i + n, !0, !0) : e.set(r + t, i + n, !1, !0)
        }
    }
    function _(e, t) {
    ...
    function b(e, n, i) {
        ...
        for (a.getLengthInBits() + 4 <= o && a.put(0, 4); a.getLengthInBits() % 8 != 0; )
            a.putBit(0);
...
`);
    ...
    e.create = function(e, r) {
        ...
        let i = n.M, a, o;
        return r !== void 0 && (i = n.from(r.errorCorrectionLevel, n.M),
        a = u.from(r.version),
  ...
  , Ge = o((e => {
    ...
    e.render = function(e, i, a) {
        ...
        return t.qrToImageData(u.data, e, o),
        n(l, s, c),
  ...
  , Ke = o((e => {
    ...
    function i(e, t, n) {
        ...
        for (let c = 0; c < e.length; c++) {
            ...
            !l && !o && (o = !0),
            e[c] ? (s++,
            c > 0 && l > 0 && e[c - 1] || (i += o ? r(`M`, l + n, .5 + u + n) : r(`m`, a, 0),
            a = 0,
            o = !1),
            l + 1 < t && e[c + 1] || (i += r(`h`, s),
            s = 0)) : a++
    ...
    e.render = function(e, r, a) {
        let o = t.getOptions(r)
          ...
          , c = e.modules.data
          , l = s + o.margin * 2
          , u = o.color.light.a ? `<path ` + n(o.color.light, `fill`) + ` d="M0 0h` + l + `v` + l + `H0z"/>` : ``
...
`;
        return typeof a == `function` && a(null, p),
        p
    }
}
))
  , qe = c(o((e => {
    ...
    function a(e, r, i, a, o) {
        ...
        if (l) {
            ...
            c === 2 ? (o = i,
            i = r,
            r = a = void 0) : c === 3 && (r.getContext && o === void 0 ? (o = a,
            a = void 0) : (o = a,
            a = i,
            i = r,
            r = void 0))
            ...
            if (c < 1)
                throw Error(`Too few arguments provided`);
            return c === 1 ? (i = r,
            r = a = void 0) : c === 2 && !r.getContext && (a = i,
            i = r,
            r = void 0),
...
function Je(e) {
    try {
        let {modules: t} = qe.create(e || `https://www.gestionvelora.com/`, {
...
function Xe(e, t, n=0) {
    let r = Math.sin(e * 127.1 + t * 311.7 + n * 43.7) * 43758.5;
...
function Ze(e) {
    ...
    for (let c = 0; c < t; c++)
        for (let d = 0; d < t; d++) {
            ...
            a.push(C),
            o.push(0),
            t ? m < 2.5 ? s.push(Ye.Trunk) : m >= l ? s.push(Ye.Grass) : s.push(Ye.FallenPetals) : s.push(Ye.Dirt),
            u++
        }
    for (let c = 0; c < t; c++)
        for (let l = 0; l < t; l++) {
    ...
    for (let d = 0; d < t; d++)
        for (let f = 0; f < t; f++) {
            ...
            if (m < l) {
                let e = 1 - m / l
                  , t = Math.max(3, Math.round(12 * (.25 + .75 * e * e)));
                for (let n = 0; n < t; n++) {
                    let t = c + n * C
                      , r = Math.floor(e * 3) * C;
                    i.push(f, d, 0, 0),
                    a.push(C),
                    o.push(t + r),
                    s.push(Ye.CherryBlossom),
                    u++
                }
                let n = Math.floor(Xe(f, d, 500) * 4);
                for (let r = 0; r < n; r++) {
                    let n = t + r
                      , l = Math.floor(e * 3) * C;
                    i.push(f, d, 0, 0),
...
function Qe(e) {
    ...
    for (let e = 0; e < t; e++)
        for (let c = 0; c < t; c++) {
            ...
            if (u < a && u >= 2.5) {
                let t = 1 - u / a
                  , n = Math.max(3, Math.round(12 * (.25 + .75 * t * t))) + Math.floor(Xe(c, e, 500) * 4)
                  , r = Math.floor(t * 3) * C
                  , l = i + (n - 1) * C + r + C
                  , d = 4 + Math.floor(Xe(c, e, 600) * 3);
                for (let t = 0; t < d; t++) {
                    let n = Xe(c, e, 777 + t)
                      , r = (Xe(c, e, 800 + t) - .5) * 1.2
                      , i = (Xe(c, e, 900 + t) - .5) * 1.2
                      , a = (Xe(c, e, 1e3 + t) - .6) * C * 2;
                    o.push(c + r, e + i, l + a, n),
                    s++
                }
                if (Xe(c, e, 1100) < .35) {
                    let t = Xe(c, e, 1200) + 1
...
function $e(e) {
    ...
    return {
        ...
        edgeRatio: s,
        trunkHeight: .26 + o * .08,
        trunkRadius: .024 + o * .008,
        trunkLean: .04 + M(o, s) * .03,
        mainBranches: 4 + Math.floor(o * 4),
        branchSpread: .5 + s * .5,
        branchLengthScale: .55 + o * .25,
        maxDepth: s > .28 ? 5 : 4,
        canopyDensity: .5 + o * .5
    }
}
function et(e, t) {
    let n = t * ee * S
      , r = []
      , i = []
      , {trunkHeight: a, trunkRadius: o, trunkLean: s, mainBranches: c, branchLengthScale: l, maxDepth: u} = e
      , d = 0;
    function f(e, t, n, i, a, o, s, c, l, u) {
        r.push(e, t, n, i, a, o, s, c, l, u, 0, 0),
        d++
    }
    for (let e = 0; e < 10; e++) {
        let t = e / 10
          , n = (e + 1) / 10
          , r = 1 + Math.sin(t * Math.PI * .8) * .08
          , i = 1 + Math.sin(n * Math.PI * .8) * .08
          , c = o * (1 - t * .55) * r
          , l = o * (1 - n * .55) * i
          , u = s * t * t + s * .3 * Math.sin(t * Math.PI * 1.5)
          , d = s * .5 * Math.sin(t * Math.PI * .8)
          , p = s * n * n + s * .3 * Math.sin(n * Math.PI * 1.5)
          , m = s * .5 * Math.sin(n * Math.PI * .8);
        f(u, t * a, d, c, p, n * a, m, l, 0, t * .5)
    }
    function p(e) {
        return {
            x: s * e * e + s * .3 * Math.sin(e * Math.PI * 1.5),
            y: a * e,
            z: s * .5 * Math.sin(e * Math.PI * .8)
        }
    }
    let m = a + n * .9;
    function h(e, t, r, a, o, s, c, p, m, h) {
        if (d >= 485)
            return;
        f(e, t, r, a, o, s, c, p, h, M(d, 0, 400));
        let g = 1 + Math.floor(M(d, 0, 500) * 2);
        for (let e = 0; e < g && !(d >= 485); e++) {
            let t = m + (M(d, e, 600) - .5) * 2
              , r = n * (.15 + M(d, e, 700) * .2) * l
              , a = .15 + M(d, e, 750) * .6
              , g = p * (.5 + M(d, e, 800) * .2)
              , _ = o + Math.cos(t) * Math.cos(a) * r
              , v = s + Math.sin(a) * r
              , y = c + Math.sin(t) * Math.cos(a) * r
              , b = g * .4
              , x = Math.sqrt(_ * _ + y * y);
            if (x > n * .95 && (_ *= n * .95 / x,
            y *= n * .95 / x),
            f(o, s, c, g, _, v, y, b, h + 1, M(d, e, 850)),
            i.push({
                x: _,
                y: v,
                z: y,
            ...
            u >= 4 && d < 485) {
                let a = t + (M(d, e, 860) - .5) * 2
                  , o = r * .45
                  , s = .3 + M(d, e, 870) * .5
                  , c = b * .5
                  , l = _ + Math.cos(a) * Math.cos(s) * o
                  , u = v + Math.sin(s) * o
                  , p = y + Math.sin(a) * Math.cos(s) * o
                  , m = Math.sqrt(l * l + p * p);
                m > n * .95 && (l *= n * .95 / m,
                p *= n * .95 / m),
                f(_, v, y, b, l, u, p, c * .3, h + 2, M(d, e, 880)),
                i.push({
                    x: l,
                    y: u,
                    z: p,
    ...
    let g = 3 + Math.floor(M(0, 0, 2e3) * 2)
      , _ = p(.95);
    for (let e = 0; e < g && !(d >= 470); e++) {
        let t = e / g * Math.PI * 2 + M(e, 0, 2100) * .5
          , r = n * (.1 + M(e, 0, 2200) * .25)
          , a = o * (.3 + M(e, 0, 2300) * .12)
          , s = 2 + Math.floor(M(e, 0, 2400))
          , c = _.x
          , l = _.y
          , u = _.z
          , p = a;
        for (let n = 0; n < s && !(d >= 475); n++) {
            let i = (n + 1) / s
              , a = (M(e, n, 2500) - .5) * .01
              , o = (M(e, n, 2600) - .5) * .01
              , d = _.x + Math.cos(t) * r * i + a
              , h = _.y + (m - _.y) * i * (.7 + M(e, n, 2700) * .3)
              , g = _.z + Math.sin(t) * r * i + o
              , v = p * (.5 + M(e, n, 2800) * .1);
            f(c, l, u, p, d, h, g, v, 1, M(e, n, 2900)),
            c = d,
            l = h,
            u = g,
            p = v
        ...
        h(c, l, u, p * .7, c + (M(e, 0, 3e3) - .5) * n * .3, l + n * .1, u + (M(e, 0, 3100) - .5) * n * .3, p * .3, t, 2)
    }
    for (let e = 0; e < c && !(d >= 470); e++) {
        let t = p(.7 + M(e, 0, 1200) * .25)
          , r = e / c * Math.PI * 2 + (M(e, 0, 900) - .5) * .4
          , s = n * (.6 + M(e, 0, 1e3) * .35)
          , l = a * (.85 + M(e, 0, 1050) * .35)
          , u = Math.cos(r) * s
          , m = Math.sin(r) * s
          , g = t.x
          , _ = t.y
          , v = t.z
          , y = o * (.4 + M(e, 0, 1100) * .15);
        for (let i = 0; i < 3 && !(d >= 475); i++) {
            let a = (i + 1) / 3
              , o = Math.sin(a * Math.PI) * n * .3
              , s = (M(e, i, 150) - .5) * .015
              , c = (M(e, i, 250) - .5) * .015
              , p = t.x + (u - t.x) * a + s
              , b = t.y + (l - t.y) * a + o * (1 - a)
              , x = t.z + (m - t.z) * a + c
              , S = y * (.55 + M(e, i, 350) * .1);
            f(g, _, v, y, p, b, x, S, 1, M(e, i, 400)),
            i >= 1 && d < 470 && h(p, b, x, S * .6, p + (M(e, i, 610) - .5) * n * .4, b + n * (.1 + M(e, i, 620) * .15), x + (M(e, i, 630) - .5) * n * .4, S * .25, r, 2),
            g = p,
            _ = b,
            v = x,
            y = S
...
function tt(e, t) {
    ...
    for (let n = 0; n < e.length; n++) {
        ...
        if (M(n, 0, 780) < .04)
            continue;
        let s = .8 + M(n, 3, 790) * .6
          , c = Math.max(12, Math.floor(r.radius * 14 * t.canopyDensity * s))
          , l = r.radius * S * 3.8 * s;
        for (let e = 0; e < c; e++) {
            let t = M(n, e, 800)
              , s = M(n, e, 810) * Math.PI * 2
              , c = M(n, e, 820) * 2 - 1
              , u = Math.sqrt(1 - c * c)
              , d = l * Math.cbrt(M(n, e, 830))
              , f = r.x + d * u * Math.cos(s) * 1.3
              , p = r.y + d * c * .7 + l * .15
              , m = o(f, r.z + d * u * Math.sin(s) * 1.3);
            i.push(m.col, m.row, p, t),
            a++
        }
        let u = 2 + Math.floor(M(n, 0, 1500) * 3);
        for (let e = 0; e < u; e++) {
            let t = M(n, e, 1600)
              , s = M(n, e, 1700) * Math.PI * 2
              , c = l * .5
              , u = r.x + Math.cos(s) * c
              , d = r.z + Math.sin(s) * c
              , f = r.y - C * (.5 + M(n, e, 1900) * 2)
              , p = o(u, d);
            i.push(p.col, p.row, f, t),
            a++
        }
        if (M(n, 2, 900) < .5) {
            let e = M(n, 0, 910) + 1
              , t = M(n, 0, 920) * Math.PI * 2
              , s = r.x + Math.cos(t) * l * .4
              , c = r.z + Math.sin(t) * l * .4
              , u = r.y - C * .5
              , d = o(s, c);
            i.push(d.col, d.row, u, e),
            a++
        }
    }
    let s = n * ee * S
...
function nt(e, t, n=10) {
    ...
    for (let t = 0; t < n; t++) {
        let n = e[Math.floor(M(t, 0, 5e3) * e.length) % e.length]
          , o = M(t, 0, 5100)
          , s = M(t, 0, 5200) * Math.PI * 2
          , c = n.radius * S * 1.5 * M(t, 0, 5300)
          , l = n.x + Math.cos(s) * c
          , u = n.z + Math.sin(s) * c
          , d = n.y + C * (.5 + M(t, 0, 5400) * 1)
          , f = (l + r) / S
          , p = (u + r) / S;
        i.push(f, p, d, o),
        a++
...
function it(e, t) {
    let n = []
      ...
      , s = e * ee;
    for (let c = 0; c < e; c++)
        for (let l = 0; l < e && !(r >= i); l++) {
            let e = l - a
              , u = c - o
              , d = Math.sqrt(e * e + u * u);
            if (d < 2.5 * 2 || !(t && t[c] && t[c][l]) || d < s)
                continue;
            let f = 14 + Math.floor(rt(l, c, 5100) * 8);
            for (let e = 0; e < f && !(r >= i); e++) {
                let t = rt(l, c, 5200 + e)
                  , i = (rt(l, c, 5300 + e) - .5) * .85
                  , a = (rt(l, c, 5400 + e) - .5) * .85
                  , o = S * (.5 + rt(l, c, 5500 + e) * 1.2);
                n.push(l + i, c + a, t, o),
                r++
            }
        }
...
function ot({canvasRef: e, canvasWidth: t, canvasHeight: n, qrContent: r, isFlat: i, seasonRef: a}) {
    let o = (0,
    _.useRef)(null)
      , s = (0,
    _.useRef)(Date.now())
    ...
    _.useEffect)( () => {
        ...
        x.current = {
            numBlocks: _.numBlocks,
            gridSize: _.gridSize
        };
        let T = $e(u)
          , te = et(T, _.gridSize);
        if (C.current = {
            segmentCount: te.segmentCount
        },
        s) {
            let t = new Float32Array(500 * 12);
            t.set(te.segments),
            e.queue.writeBuffer(s, 0, t)
        }
        if (o) {
            let t = tt(te.tips, T)
              , n = Qe(u)
              , r = t.count + n.count
              , i = new Float32Array(ae * 4);
            i.set(t.positions),
            i.set(new Float32Array(n.positions), t.count * 4),
            S.current = {
                flowerCount: r
            },
            e.queue.writeBuffer(o, 0, i)
        }
        if (c) {
            let t = nt(te.tips, _.gridSize, 10);
            w.current = {
                petalCount: t.count
            };
            let n = new Float32Array(40);
            n.set(t.positions),
            e.queue.writeBuffer(c, 0, n)
        }
        if (l) {
            let t = it(_.gridSize, u);
            ee.current = {
                grassCount: t.count
            };
            let n = new Float32Array(oe * 4);
            n.set(t.positions),
            e.queue.writeBuffer(l, 0, n)
        }
    }
    , [r]);
    let E = (0,
    _.useCallback)(async () => {
        try {
            if (!e.current)
                return;
            let r = e.current
              , _ = r.getContext(`webgpu`);
            if (!_)
                return;
            let E = await navigator.gpu?.requestAdapter();
            if (!E)
                return;
            let D = await E.requestDevice();
            d.current = D;
            let ne = navigator.gpu.getPreferredCanvasFormat()
            ...
            let be = tt(A.tips, k)
              , xe = Qe(ie);
            S.current = {
                flowerCount: be.count + xe.count
            };
            let Se = D.createBuffer({
                size: 32,
            ...
            f.current = we;
            let Te = D.createBuffer({
                size: T * 16,
                usage: GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST
            });
            p.current = Te;
            let Ee = D.createBuffer({
                size: T * 4,
                usage: GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST
            });
            m.current = Ee;
            let De = D.createBuffer({
                size: T * 4,
                usage: GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST
            });
            h.current = De;
            let Oe = D.createBuffer({
                size: ae * 16,
                usage: GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST
            });
            g.current = Oe;
            let ke = D.createBuffer({
                size: 500 * 12 * 4,
                usage: GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST
            });
            v.current = ke;
            let Ae = D.createBuffer({
                size: oe * 16,
                usage: GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_DST
            });
            b.current = Ae;
            let je = D.createBuffer({
                size: 32,
                usage: GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST
            })
              , Me = D.createBuffer({
            ...
            let Pe = new Float32Array(ae * 4);
            Pe.set(be.positions),
            Pe.set(new Float32Array(xe.positions), be.count * 4),
            D.queue.writeBuffer(Oe, 0, Pe);
            let Fe = new Float32Array(500 * 12);
            Fe.set(A.segments),
            D.queue.writeBuffer(ke, 0, Fe);
            let Ie = it(O.gridSize, ie);
            ee.current = {
                grassCount: Ie.count
            };
            let Le = new Float32Array(oe * 4);
            Le.set(Ie.positions),
            D.queue.writeBuffer(Ae, 0, Le);
            let Re = nt(A.tips, O.gridSize, 10);
            w.current = {
                petalCount: Re.count
            };
            let ze = new Float32Array(40);
            ze.set(Re.positions),
            D.queue.writeBuffer(Me, 0, ze);
            let Be = D.createBindGroupLayout({
                entries: [{
                    binding: 0,
            ...
            try {
                ...
                console.log(`Branch pipeline created, segments:`, A.segmentCount)
            } catch (e) {
                console.error(`Branch pipeline failed (non-fatal):`, e)
            }
            let P = null;
            try {
                P = ct(D, ne, Ye, {
                ...
                console.error(`Grass pipeline failed (non-fatal):`, e)
            }
            let dt = ct(D, ne, We, {
                vertex: fe,
                fragment: pe,
            ...
            try {
                ...
                console.error(`Falling flower pipeline failed (non-fatal):`, e)
            }
            let pt = D.createTexture({
              ...
              , ht = () => {
                let e = Date.now()
                  , t = Math.min((e - u.current) / 1e3, .05);
                u.current = e;
                let n = i.current ? 1 : 0;
                l.current += (n - l.current) * Math.min(1, 4 * t),
                Math.abs(l.current - n) < .001 && (l.current = n),
                c.current = at(l.current);
                let r = (e - s.current) / 1e3
                  , {numBlocks: d, gridSize: f} = x.current
                  , {segmentCount: p} = C.current
                  , m = 1 - c.current
                  , h = Math.sin(r * .15) * .003 * m
                  , g = Math.sin(r * .11 + 1) * .002 * m
                  , v = a ? a.current : 0
                  , y = new Float32Array([mt, r, d, c.current, f, h, g, v]);
                D.queue.writeBuffer(Se, 0, y);
                let b = new Float32Array([mt, r, p, c.current, f, h, g, v]);
                D.queue.writeBuffer(Ce, 0, b);
                let {grassCount: T} = ee.current
                  , te = new Float32Array([mt, r, T, c.current, f, h, g, v]);
                D.queue.writeBuffer(je, 0, te);
                let {petalCount: E} = w.current
                  , ne = new Float32Array([mt, r, E, c.current, f, h, g, v]);
                D.queue.writeBuffer(Ne, 0, ne);
                let re = D.createCommandEncoder()
                  , ie = _.getCurrentTexture().createView()
                  , O = re.beginRenderPass({
                    colorAttachments: [{
                        view: ie,
                        clearValue: {
                            r: 0,
                ...
                O.setBindGroup(0, Ve),
                O.draw(36 * d),
                T > 0 && P && (O.setPipeline(P),
                O.setBindGroup(0, Xe),
                O.draw(3 * T)),
                p > 0 && ut && (O.setPipeline(ut),
                O.setBindGroup(0, qe),
                O.draw(48 * p));
                let {flowerCount: ae} = S.current;
                ae > 0 && (O.setPipeline(dt),
                O.setBindGroup(0, Ge),
                O.draw(150 * ae)),
                E > 0 && ft && (O.setPipeline(ft),
                O.setBindGroup(0, rt),
                O.draw(150 * E)),
                O.end(),
                D.queue.submit([re.finish()]),
                o.current = requestAnimationFrame(ht)
            }
            ;
            ht()
        } catch (e) {
...
function st(e, t, n) {
    let {types: r, positions: i, heights: a, baseY: o} = t
      , s = new Uint32Array(T);
    s.set(r),
    e.queue.writeBuffer(n.typeBuffer, 0, s);
    let c = new Float32Array(T * 4);
    c.set(i),
    e.queue.writeBuffer(n.posBuffer, 0, c);
    let l = new Float32Array(T);
    l.set(a),
    e.queue.writeBuffer(n.heightBuffer, 0, l);
    let u = new Float32Array(T);
    u.set(o),
    e.queue.writeBuffer(n.baseYBuffer, 0, u)
}
function ct(e, t, n, r) {
    let i = {
        color: {
    ...
    return a.getCompilationInfo().then(e => {
        for (let t of e.messages)
            t.type === `error` && console.error(`Vertex shader error:`, t.message, `line:`, t.lineNum)
    }
    ),
    o.getCompilationInfo().then(e => {
        for (let t of e.messages)
            t.type === `error` && console.error(`Fragment shader error:`, t.message, `line:`, t.lineNum)
    }
    ),
    e.createRenderPipeline({
        ...
        depthStencil: {
            depthWriteEnabled: r.depthWrite,
...
function ut() {
    ...
    _.useEffect)( () => {
        let handler = e => {
            if (e.origin !== window.location.origin)
                return;
            let t = e.data;
            if (typeof t !== `object` || t === null || t.channel !== `gv-qr-tree` || t.type !== `setSeason`)
                return;
            let n = t.season;
            typeof n === `number` && n >= 0 && n <= 3 && x(n)
        }
        ;
    ...
    N.jsx)(`div`, {
        ...
        N.jsxs)(`div`, {
            ...
            children: [(0,
            N.jsx)(`h2`, {
                children: `WebGPU Not Supported`
            }), (0,
            N.jsx)(`p`, {
                children: `This demo requires WebGPU. Please use a browser that supports WebGPU (Chrome 113+, Edge 113+, or Firefox Nightly with flags enabled).`
            })]
        })
    })
}
