      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Predictable communication—clear response timelines, single contact channels, tracked requests—reduces disputes and repeat filings with the Tribunal administratif du logement (TAL) for problems that could have been resolved upstream. Every formal complaint costs management time and creates relational friction that is difficult to undo once established.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Ask about emergency response policy (target timelines, escalation process), the list of qualified vendors used, and documented experience with your specific asset type (condo board, rental multiplex, Airbnb). A manager specialized in condo boards may not have the reflexes or network to efficiently manage an intensive Airbnb rotation portfolio—and vice versa. Specialization matters.",
