...
name: nothing-design
description: >-
  Use only when the user explicitly says "Nothing style", "Nothing design", "/nothing-design",
  or asks to apply the Nothing design system. Never trigger automatically for generic UI or
  design tasks.
metadata:
  version: 3.1.0
  source: https://github.com/dominikmartn/nothing-design-skill (MIT; vendored in repo)
---
...
## 6. COMPANION CRAFT (OPTIONAL)

For **motion, drag, modal composition, and design-engineer workflow** that stays compatible with Nothing’s typography-first, low-chrome baseline:

**Optional skill install** (Curator / project skills):
...
Vendored from [dominikmartn/nothing-design-skill](https://github.com/dominikmartn/nothing-design-skill) (MIT). See `LICENSE` in this folder.
