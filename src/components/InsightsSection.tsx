      ...
      <div className="max-w-[90rem] mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          ...
          <div className="flex items-center gap-3">
            <InternalLink
              to="/blog"
              className="px-6 py-3 rounded-full bg-waabi-pink text-white font-sans font-bold text-sm hover:bg-waabi-pink/90 shrink-0"
            >
              {t("insights.seeAll")}
            </InternalLink>
            <div className="flex gap-2">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-full border-2 border-black/20 dark:border-white/20 flex items-center justify-center text-black dark:text-white hover:border-waabi-pink hover:text-waabi-pink"
              >
