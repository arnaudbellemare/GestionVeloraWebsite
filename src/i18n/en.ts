export const en = {
  ...
  valueLabels: {
    ...
    proactive: "Proactive",
    proactiveText:
      "Preventive maintenance and early detection of issues before they escalate.",
    reliable: "Reliable",
    reliableText:
      "24/7 available team, proven processes, and unwavering commitment.",
  },
  ...
  whatWeDo: {
    ...
    syndicatDetails:
      "Full administration, annual meetings, reserve funds and major works. Transparency and rigour for every condo board.",
    airbnbDetails:
  ...
  fromInspiration: {
    ...
    archive: "Archive by building",
    archiveDesc:
      "Organize documents by condo, fiscal year and type. Find any piece in seconds.",
    comment: "Annotate and collaborate",
    commentDesc:
      "Ask questions or add notes on a quote, report or decision. Context stays at hand.",
    exportReport: "Export report",
    downloaded: "Downloaded",
    archiveIn: "Archive to",
  ...
  trustedPartners: {
    ...
    partners: [
      ...
      { name: "Nickel & Krome", quote: "We work with Gestion Velora and they really know how to make things go well without complexity. A smooth, clear and professional partnership.", author: "Karim Alyan", role: "Nickel & Krome", evidence: "Active partner collaboration, 2025-2026.", website: "nickelandkrome.ca" },
    ],
  },
  ...
  propertyTools: {
    ...
    communicate: "Centralized communication.",
    communicateDesc:
      "Exchange with owners and tenants in the right place. Ask questions directly on a report, quote or decision.",
    overview: "Overview.",
    overviewDesc:
  ...
  portalAccess: {
    ...
    subtitle: "Log in to the manager or owner portal according to your profile.",
    manager: "Manager portal",
    managerDesc: "Accounting, documents, requests, approvals and reports.",
    owner: "Owner portal",
    ownerDesc: "View fees, documents, requests and meetings.",
    accessPortal: "Access portal",
    learnMore: "Learn more about Nestreva, the management platform for managers and owners:",
    more: "learn more",
  },
  ...
  faqItems: [
    ...
    {
      question: "Airbnb in Montreal: permits and regulation?",
      answer:
    ...
    {
      question: "What is the condo reserve fund?",
      answer:
    ...
    {
      question: "What are condo fees (common charges)?",
      answer:
  ...
  footer: {
    ...
    qrSeasonAutumn: "Autumn",
    qrSeasonWinter: "Winter",
  },
  ...
  privacy: {
    ...
    p1:
      "Gestion Velora is committed to protecting the privacy of individuals who use its services and visit its website.",
    collectTitle: "Information collection",
    collectText:
      "We collect information you voluntarily provide when contacting us, including your name, email and message. This data is used only to respond to your requests and improve our services.",
    useTitle: "Use of information",
    useText:
      "Collected information is not shared with third parties. It is used solely for communication with Gestion Velora and client relationship management.",
      ...
      offerings: [
        {
          ...
          items: [
            ...
            "Request and confirmation handling",
        ...
        },
        {
          ...
          items: [
            "Compliance with Montreal bylaws",
      ...
      offerings: [
        {
          ...
          items: [
            "Advertising and listing distribution",
            "Tours and applicant screening",
